...
sh -n scripts/build-release.sh scripts/check-container.sh scripts/check-postgres.sh scripts/check-performance.sh scripts/check-wire-compatibility-matrix.sh scripts/check-wire-compatibility-release.sh scripts/check-release-admission.sh scripts/check-release-build.sh
