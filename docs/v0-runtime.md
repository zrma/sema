...
이 문서는 `cmd/sema-server` development/reference 및 optional import compatibility runtime만 다룬다. 신규 설치의 표준 PostgreSQL/OIDC runtime은 `docs/operations-runbook.md`를 따른다.
