...
제품 semantics, fairness와 latency의 수치, accepted implementation baseline 변경, consistency guarantee 확장, credential·비용, 파괴적 변경, public 전환, published history rewrite, 승인되지 않은 push가 필요할 때만 사용자에게 최소 판단을 요청한다.
