...
- 무컨텍스트 시작점: `docs/HANDOFF.md`; 현재 작업 계약: 활성 `docs/todo-*/spec.md`와 `decisions.md`.
...
- Active foundation: `docs/todo-0001-foundation/spec.md`, `docs/todo-0001-foundation/decisions.md`.
