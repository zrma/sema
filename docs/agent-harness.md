...
- Service product readiness: `docs/todo-0042-service-product-readiness/spec.md`, `docs/service-workload.md`, `docs/decisions/0027-standalone-product-scope.md`, `docs/decisions/0028-standard-service-runtime.md`, `docs/decisions/0029-standard-service-resource-profile.md`.
