...
- Service productization: `docs/todo-0040-service-productization-entry/spec.md`, `docs/service-authority.md`, `docs/decisions/0016-service-authority-contract.md`.
