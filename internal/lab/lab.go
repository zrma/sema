	...
	summary := ScenarioResult{
		...
		Outcome: OutcomeSummary{
			...
			Batch: BatchSummary{
				...
				WaitPriorityEligibleDemands:  result.Batch.Evidence.WaitPriorityEligibleDemands,
				WaitPrioritySelectedDemands:  result.Batch.Evidence.WaitPrioritySelectedDemands,
				OldestWaitPriorityMillis:     result.Batch.Evidence.OldestWaitPriorityMillis,
				OldestSelectedPriorityMillis: result.Batch.Evidence.OldestSelectedPriorityMillis,
