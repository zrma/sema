...
P0 architecture foundation과 Go 인메모리 vertical slice가 완료되었다. 현재 구현은 deterministic bounded enumeration, disjoint `ProposalBatch`, revision/CAS reservation lifecycle을 실행 가능한 fixture로 검증하며, 다음 단계는 time-dependent objective policy다.
