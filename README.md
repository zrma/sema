...
P0 architecture foundation과 P1 objective policy가 완료되었다. 현재 구현은 deterministic bounded candidate ranking, wait-based skill/role relaxation, stable unmatched reason, disjoint `ProposalBatch`, revision/CAS reservation lifecycle을 실행 가능한 fixture로 검증한다.
