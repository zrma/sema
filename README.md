...
P0 architecture foundation, P1 objective policy, P2 assignment lifecycle이 완료되었다. 현재 구현은 deterministic bounded candidate ranking, wait-based skill/role relaxation, stable unmatched reason, revision/CAS reservation과 terminal assignment acknowledgment를 실행 가능한 fixture로 검증한다.
